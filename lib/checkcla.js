...
function createOrUpdateFile(pathToClaSignatures, sha, contentBinary, branch) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error.status === 404) {
                ...
                const response = yield createOrUpdateFile(pathToClaSignatures, sha, initalContentBinary, branch);
        ...
        try {
            ...
            yield createOrUpdateFile(pathToClaSignatures, sha, contentBinary, branch);
