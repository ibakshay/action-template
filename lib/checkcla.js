...
function getclas() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        prepareCommiterMap(committers, clas);
        // console.log('unsigned contributors are: ' + JSON.stringify(committerMap.notSigned, null, 2))
        // console.log('signed contributors are: ' + JSON.stringify(committerMap.signed, null, 2))
        ...
        try {
            const reactedCommitters = yield pullRequestComment_1.default(signed, committerMap, committers);
            ...
            if (reactedCommitters.newSigned) {
                ...
                yield updateFile(pathToClaSignatures, sha, contentBinary, branch);
            }
