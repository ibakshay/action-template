    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error.status === 404) {
                ...
                const promise = Promise.all([createFile(pathToClaSignatures, initalContentBinary, branch), pullRequestComment_1.default(signed, committerMap)]);
                if (promise) {
        ...
        try {
            ...
            const promise = Promise.all([pullRequestComment_1.default(signed, committerMap), updateFile(pathToClaSignatures, sha, contentBinary, branch)]);
