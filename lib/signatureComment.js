...
function webhookSmartContract(newSignedCommitters) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch('https://smee.io/U0QcVDf68Leo2HEp', config);
...
function signatureWithPRComment(commentId, committerMap, committers) {
    return __awaiter(this, void 0, void 0, function* () {
        let repoId = github_1.context.payload.repository;
