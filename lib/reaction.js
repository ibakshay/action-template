...
function reaction(commentId, committerMap, committers) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // }
        reactedCommitterMap.newSigned = lodash_1.default.merge(reactedCommitters, lodash_1.default.map(committerMap.notSigned, function (obj) {
            return lodash_1.default.pick(obj, 'id', 'pullRequestNo');
        }));
