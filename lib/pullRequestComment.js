...
function reaction(commentId, committerMap) {
    return __awaiter(this, void 0, void 0, function* () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!prComment) {
                ...
                yield reaction(prComment.id, committerMap);
                console.log("---->>>>><<<<<<<<ttatatatttata");
                const values = yield Promise.all([reaction(prComment.id, committerMap), octokit_1.default.issues.updateComment({
                        owner: github_1.context.repo.owner,
                        repo: github_1.context.repo.repo,
