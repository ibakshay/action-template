...
function commentContent(signed, committerMap) {
    ...
    console.log("I am from prComment and path to cla is :" + url_1.pathToCLADocument);
    ...
    let text = `**CLA Assistant Lite:** <br/>Thank you for your submission, we really appreciate it. Like many open source projects, we ask that ${you} sign our [Contributor License Agreement](${url_1.pathToCLADocument}) before we can accept your contribution.<br/>`;
...
function prComment(signed, committerMap) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
