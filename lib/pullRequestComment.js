    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!prComment) {
                ...
                const reactedCommitters = yield reaction(prComment.id, committerMap, committers);
                ...
                const reactedCommittersFlag = committers.every(committer => reactedCommitters.some(reactedCommitter => committer.name === reactedCommitter.name));
