...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            //       }
            //     })
            const committers = graphql_1.default();
            ...
            let result, content;
            try {
                result = yield octokit_1.default.repos.getContents(args2);
                //console.log(result)
            ...
            try {
                updateFile = yield octokit_1.default.repos.createOrUpdateFile(args3);
            }
            catch (e) {
